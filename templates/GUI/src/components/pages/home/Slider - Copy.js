            ...
            <section id="hero">
                <div id="heroCarousel" data-bs-interval="5000" className="carousel slide carousel-fade" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner" role="listbox">
                        <div className="carousel-item active" id="caruorsel_slider_1" style={{ backgroundImage: 'url(../../static/img/produce/rice.jpg)' }}>
                            <div className="carousel-container">
                                <div className="carousel-content animate__animated animate__fadeInUp">
                                    <h2>Welcome to <span>Agrolyte</span></h2>
                                    <p>We ease the stress of going to the open market and save time and energy of our busy clients</p>
